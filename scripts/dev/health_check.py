...
REQUIRED_FILES = [
    ...
    "workspace/projects/workspace_system/constraints.md",
    "workspace/projects/workspace_system/ops.md",
    "workspace/projects/workspace_system/active_plan.md",
    "workspace/projects/workspace_system/progress.md",
    "workspace/projects/workspace_system/failure_registry.md",
